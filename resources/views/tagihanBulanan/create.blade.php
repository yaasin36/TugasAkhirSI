                            ...
                            <form action="{{ route('storeTagihan') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama_tagihan" id="nama_tagihan" class="form-control"
                                            required placeholder="Masukkan Nama Tagihan">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="awal_tagihan" id="awal_tagihan" class="form-control"
                                            required placeholder="Masukkan Tanggal Tagihan">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="akhir_tagihan" id="akhir_tagihan"
                                            class="form-control" readonly placeholder="Masukkan Jatuh Tempo">
                                    </div>
                                </div>
