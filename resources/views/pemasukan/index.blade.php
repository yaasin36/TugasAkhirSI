                        ...
                        <div class="col-lg-6">
                            <div class="card shadow mb-4">
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-white">Diagram Pendapatan</h6>
                                </div>
                                <div class="card-body">
                                    {{-- diagram --}}
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-hijau"></i> Pendapatan
                                        </span>
                                    </div>
                                </div>
                            </div>
