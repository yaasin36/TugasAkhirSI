        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0" style="color: #858796;">Tambah Kredit</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <form action="{{ route('storeKredit') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama_kredit" id="nama_kredit" class="form-control" required placeholder="Masukkan Nama Kredit">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="awal_kredit" id="awal_kredit" class="form-control" required placeholder="Masukkan Tanggal Kredit" onchange="calculateJatuhTempo()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="akhir_kredit" id="akhir_kredit" class="form-control" required readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="jumlah" id="jumlah" placeholder="Masukkan Jumlah Kredit">
                                    </div>
                                </div>
